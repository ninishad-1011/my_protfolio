  ...
  return (
    <div className="relative min-h-screen py-16 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="w-2 h-2 bg-[#1c1e22] rounded-full absolute animate-float" style={{ top: "25%", left: "15%" }}></div>
        <div className="w-1.5 h-1.5 bg-[#2a2c30] rounded-full absolute animate-float-slow" style={{ top: "70%", left: "75%" }}></div>
        <div className="w-3 h-3 bg-[#00ADB5] rounded-full absolute animate-float-medium" style={{ top: "50%", left: "50%" }}></div>
      </div>

      <div className="container mx-auto max-w-6xl relative z-10">
        <h1 className="text-4xl font-bold text-center text-white mb-16">My Projects</h1>
